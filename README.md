...
Ambient NPCs, cats, and dogs do not enter any cave level. The cave uses cave-only Zombies instead; they are human-shaped enemy sprites, wander through the dungeon when not chasing players, and touching a Zombie deals 20% of the player's max HP as prototype dungeon damage.
