import{P as u}from"./phaser-CeIIdTfV.js";import{P as p,C as h,G as S,a as r,c as m,S as v,H as f,O as g,A as y,b as E,D as C}from"./index-CsfbnjdM.js";import{l as P,c as b,g as w,b as T,s as A,a as L,d as $,e as V}from"./localSave-Dco1oN9t.js";class O extends u.Scene{root;savedProfile=null;editMode=!0;formState=this.createEmptyFormState();screenMessage="";constructor(){super("CharacterSelectScene")}create(t={}){this.cameras.main.setBackgroundColor("#123133"),this.savedProfile=P()??t.profile??null,this.screenMessage=t.message??"",this.editMode=this.savedProfile===null,this.formState=this.createFormState(this.savedProfile),this.mount(),this.events.once(u.Scenes.Events.SHUTDOWN,this.unmount,this)}mount(){this.unmount();const t=document.getElementById("ui-root");if(!t)throw new Error("WULAND UI root is missing.");const e=document.createElement("div");e.className="character-screen",e.innerHTML=this.template(),t.appendChild(e),this.root=e,this.bindFormControls(),this.bindActionButtons(),this.setFormDisabled(!this.editMode),this.updatePreview(),this.updateScreenMessage(),this.updateValidationStatus()}unmount(){this.root?.remove(),this.root=void 0}template(){return`
          ...
          <form class="character-form" novalidate>
            ...
            <label>
              ...
              <select data-field="gender" name="gender">
                ...
                ${S.map(e=>`<option value="${e}">${M(e)}</option>`).join("")}
              </select>
            </label>
